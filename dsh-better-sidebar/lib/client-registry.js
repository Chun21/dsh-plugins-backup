window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/chunyu/.local/share/pnpm/store/v10/tmp/_tmp_579721_2c03618d695802c63117265cbda280a4/src/client/sidebar.module.css.mjs
		const css$3 = "[data-dsh-panel-host]{z-index:40;pointer-events:none;position:fixed;inset:0}[data-dsh-panel-host][data-dsh-panel-host-degraded]{position:absolute;top:0;left:0}.AR6SZa_toggleCluster{top:calc(3px + env(safe-area-inset-top));z-index:45;pointer-events:auto;flex-direction:row;gap:4px;display:flex;position:absolute;right:10px}.AR6SZa_panel:not(.AR6SZa_panelHidden) .AR6SZa_tabBar{padding-right:72px}.AR6SZa_toggleButton{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;transition:background var(--ds-transition-duration-slow) var(--ds-ease-in-out), color var(--ds-transition-duration-slow) var(--ds-ease-in-out);background:0 0;border:none;border-radius:50%;justify-content:center;align-items:center;display:flex}.AR6SZa_toggleButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.AR6SZa_toggleButton:disabled{opacity:.4;cursor:default}.AR6SZa_panel{z-index:40;pointer-events:auto;background:var(--dsw-alias-bg-layer-1);border-left:1px solid var(--dsw-alias-border-l2);padding-bottom:env(safe-area-inset-bottom);transition:transform var(--ds-transition-duration-slow) var(--ds-ease-in-out), width var(--ds-transition-duration-slow) var(--ds-ease-in-out);flex-direction:column;display:flex;position:absolute;top:0;bottom:0;right:0}.AR6SZa_panelHidden{pointer-events:none;visibility:hidden;transition:transform var(--ds-transition-duration-slow) var(--ds-ease-in-out), width var(--ds-transition-duration-slow) var(--ds-ease-in-out), visibility 0s linear var(--ds-transition-duration-slow);transform:translate(102%)}.AR6SZa_panel[data-dragging]{transition:none}.AR6SZa_panelResize{cursor:col-resize;z-index:2;touch-action:none;width:8px;position:absolute;top:0;bottom:0;left:-4px}.AR6SZa_panelResizeActive{background:var(--dsw-alias-interactive-bg-hover-accent)}.AR6SZa_panelBody{flex:1;min-width:0;min-height:0;display:flex}.AR6SZa_bottomPanel{z-index:40;background:var(--dsw-alias-bg-layer-1);border-top:1px solid var(--dsw-alias-border-l2);pointer-events:auto;padding-bottom:env(safe-area-inset-bottom);transition:transform var(--ds-transition-duration-slow) var(--ds-ease-in-out), height var(--ds-transition-duration-slow) var(--ds-ease-in-out);flex-direction:column;display:flex;position:absolute;bottom:0}.AR6SZa_bottomPanelHidden{pointer-events:none;visibility:hidden;transition:transform var(--ds-transition-duration-slow) var(--ds-ease-in-out), height var(--ds-transition-duration-slow) var(--ds-ease-in-out), visibility 0s linear var(--ds-transition-duration-slow);transform:translateY(102%)}.AR6SZa_bottomPanel[data-dragging]{transition:none}.AR6SZa_panel,.AR6SZa_bottomPanel{contain:layout style}body[data-dsh-sidebar-dragging] .AR6SZa_panel,body[data-dsh-sidebar-dragging] .AR6SZa_bottomPanel{will-change:transform}.AR6SZa_bottomResize{cursor:row-resize;z-index:2;touch-action:none;height:8px;position:absolute;top:-4px;left:0;right:0}.AR6SZa_bottomResizeActive{background:var(--dsw-alias-interactive-bg-hover-accent)}.AR6SZa_bottomClose{z-index:4;width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex;position:absolute;top:3px;right:6px}.AR6SZa_bottomClose:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.AR6SZa_bottomPanel .AR6SZa_tabBar{padding-right:40px}body[data-dsh-title-bar-compat] .AR6SZa_toggleCluster{top:calc(var(--dsh-title-bar-strip,40px) + 3px)}body[data-dsh-title-bar-compat] .AR6SZa_panel{padding-top:var(--dsh-title-bar-strip,40px)}.AR6SZa_cornerHandle{left:-6px;bottom:calc(var(--dsh-sidebar-height,0px) + 6px);z-index:2;cursor:nwse-resize;touch-action:none;width:12px;height:12px;position:absolute}.AR6SZa_cornerHandle:hover,.AR6SZa_cornerHandle[data-dragging]{background:var(--dsw-alias-interactive-bg-hover-accent)}.AR6SZa_iconButton{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.AR6SZa_iconButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.AR6SZa_iconButton:disabled{opacity:.4;cursor:default}.AR6SZa_workbench,.AR6SZa_split{flex:1;min-width:0;min-height:0;display:flex}.AR6SZa_splitRow{flex-direction:row}.AR6SZa_splitCol{flex-direction:column}.AR6SZa_splitChild{display:flex;position:relative;overflow:hidden}.AR6SZa_divider{z-index:3;touch-action:none;flex:none;position:relative}.AR6SZa_dividerRow:after,.AR6SZa_dividerCol:after{content:\"\";background:var(--dsw-alias-border-l2);transition:background var(--ds-transition-duration-slow) var(--ds-ease-in-out);position:absolute}.AR6SZa_dividerRow{cursor:col-resize;width:7px;margin:0 -2px}.AR6SZa_dividerRow:after{width:1px;top:0;bottom:0;left:50%;transform:translate(-50%)}.AR6SZa_dividerCol{cursor:row-resize;height:7px;margin:-2px 0}.AR6SZa_dividerCol:after{height:1px;top:50%;left:0;right:0;transform:translateY(-50%)}.AR6SZa_divider:hover:after,.AR6SZa_dividerActive:after{background:var(--dsw-alias-interactive-bg-hover-accent)}.AR6SZa_pane{background:var(--dsw-alias-bg-base);flex-direction:column;flex:1;min-width:0;min-height:0;display:flex;position:relative}.AR6SZa_paneDrop{outline:1px solid var(--dsw-alias-interactive-bg-hover-accent);outline-offset:-1px}.AR6SZa_dropOverlay{z-index:6;pointer-events:none;background:var(--dsw-alias-interactive-bg-hover-accent);opacity:.5;position:absolute}.AR6SZa_dropLeft{width:25%;top:0;bottom:0;left:0}.AR6SZa_dropRight{width:25%;top:0;bottom:0;right:0}.AR6SZa_dropUp{height:25%;top:0;left:0;right:0}.AR6SZa_dropDown{height:25%;bottom:0;left:0;right:0}.AR6SZa_dropCenter{outline:2px dashed var(--dsw-alias-interactive-bg-hover-accent);outline-offset:-2px;background:0 0;inset:25%}.AR6SZa_paneContent{flex-direction:column;flex:1;min-height:0;display:flex;overflow:hidden}.AR6SZa_paneTab{flex-direction:column;flex:1;min-height:0;display:flex}.AR6SZa_paneTabHidden{display:none}.AR6SZa_paneEmptyCards{flex:1;grid-template-columns:repeat(auto-fill,minmax(140px,1fr));align-content:start;gap:8px;min-height:0;padding:12px;display:grid;overflow:hidden}.AR6SZa_paneCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);min-width:0;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxs-strong-12);cursor:pointer;text-align:center;border-radius:8px;flex-direction:column;justify-content:center;align-items:center;gap:6px;padding:12px 8px;display:flex}.AR6SZa_paneCard:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary);border-color:var(--dsw-alias-border-l2)}.AR6SZa_paneCard:disabled{opacity:.45;cursor:default}.AR6SZa_tabBar{border-bottom:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);flex:none;align-items:stretch;height:34px;display:flex}.AR6SZa_tabBarDrop{outline:1px dashed var(--dsw-alias-interactive-bg-hover-accent);outline-offset:-1px}.AR6SZa_tabList{scrollbar-width:none;flex:1;min-width:0;display:flex;overflow-x:auto}.AR6SZa_tabList::-webkit-scrollbar{display:none}.AR6SZa_tab{min-width:64px;max-width:160px;font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-secondary);border-right:1px solid var(--dsw-alias-border-l1);cursor:pointer;user-select:none;background:0 0;flex:none;align-items:center;gap:4px;padding:0 4px 0 10px;display:flex}.AR6SZa_tab:hover{background:var(--dsw-alias-interactive-bg-hover)}.AR6SZa_tabActive{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-active)}.AR6SZa_tabTitle{text-overflow:ellipsis;white-space:nowrap;flex:1;min-width:0;overflow:hidden}.AR6SZa_tabBadge{min-width:16px;height:15px;font:var(--dsw-font-xxxs-strong-11);background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-brand-primary);border-radius:8px;flex:none;justify-content:center;align-items:center;padding:0 4px;display:inline-flex}.AR6SZa_tabClose{width:18px;height:18px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:4px;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.AR6SZa_tabClose:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.AR6SZa_tabBarPlus{background:var(--dsw-alias-bg-layer-1);width:22px;height:22px;color:var(--dsw-alias-label-tertiary);cursor:pointer;border:none;border-radius:5px;flex:none;justify-content:center;align-self:center;align-items:center;margin:0 6px;padding:0;display:inline-flex;position:sticky;right:0}.AR6SZa_tabBarPlus:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.AR6SZa_explorer{flex-direction:column;flex:1;min-height:0;display:flex}.AR6SZa_explorerHeader{flex:none;justify-content:space-between;align-items:center;gap:8px;height:36px;padding:0 8px 0 12px;display:flex}.AR6SZa_explorerRoot{font:var(--dsw-font-s-14);color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.AR6SZa_explorerBody{flex:1;min-height:0;padding:2px 6px 8px;overflow:hidden auto}.AR6SZa_explorerRow{box-sizing:border-box;width:100%;max-width:100%;height:34px;font:var(--dsw-font-s-14);color:var(--dsw-alias-label-primary);text-align:left;cursor:pointer;white-space:nowrap;animation:AR6SZa_dsh-row-in .15s var(--ds-ease-in-out);background:0 0;border:none;border-radius:8px;align-items:center;gap:6px;padding:0 8px;display:flex}.AR6SZa_explorerRow:hover{background:var(--dsw-alias-interactive-bg-hover)}.AR6SZa_explorerDir{font:var(--dsw-font-s-strong-14)}.AR6SZa_explorerHidden{opacity:.45}.AR6SZa_explorerSymlink{color:var(--dsw-alias-label-tertiary);flex:none}.AR6SZa_explorerBroken .AR6SZa_explorerName{color:var(--dsw-alias-state-error-primary)}.AR6SZa_explorerName{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.AR6SZa_explorerRef{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-2);height:20px;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xxxs-strong-11);cursor:pointer;border-radius:999px;flex:none;align-items:center;padding:0 8px;display:none}.AR6SZa_explorerRef:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.AR6SZa_explorerRow:hover .AR6SZa_explorerRef,.AR6SZa_explorerRow:focus-within .AR6SZa_explorerRef{display:inline-flex}.AR6SZa_explorerCopied{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary);flex:none}.AR6SZa_explorerError{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-state-error-primary);cursor:default}@keyframes AR6SZa_dsh-row-in{0%{opacity:0}}.AR6SZa_explorerEmpty{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);text-align:center;padding:16px}.AR6SZa_editor{flex-direction:column;flex:1;min-height:0;display:flex}.AR6SZa_editorHeader{border-bottom:1px solid var(--dsw-alias-border-l1);flex:none;align-items:center;gap:6px;padding:4px 8px;display:flex}.AR6SZa_editorTitle{min-width:0;font:var(--dsw-font-xxs-strong-12);color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:1;overflow:hidden}.AR6SZa_editorPathInput{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);min-width:0;height:28px;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-12);border-radius:6px;flex:1;padding:0 10px}.AR6SZa_editorPathInput:focus{border-color:var(--dsw-alias-border-l2);outline:none}.AR6SZa_editorTreeToggleActive{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-active)}.AR6SZa_editorBody{flex:1;min-height:0;display:flex}.AR6SZa_editorMain{flex-direction:column;flex:1;min-width:0;min-height:0;display:flex}.AR6SZa_editorTreeDock{border-left:1px solid var(--dsw-alias-border-l1);flex:none;min-height:0;display:flex;position:relative}.AR6SZa_editorTreeResize{cursor:col-resize;touch-action:none;z-index:3;width:6px;position:absolute;top:0;bottom:0;left:0}.AR6SZa_editorTreeResize:hover{background:var(--dsw-alias-border-l2)}.AR6SZa_editorTreePanel{flex-direction:column;flex:1;min-width:0;min-height:0;display:flex}.AR6SZa_editorTreePanelFull{flex:1}.AR6SZa_editorTreeSearch{border-bottom:1px solid var(--dsw-alias-border-l1);flex:none;align-items:center;gap:4px;padding:6px 8px;display:flex}.AR6SZa_editorSearchInput{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);min-width:0;height:26px;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-12);border-radius:6px;flex:1;padding:0 10px}.AR6SZa_editorSearchInput:focus{border-color:var(--dsw-alias-border-l2);outline:none}.AR6SZa_editorSearchHint{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);padding:8px 12px}.AR6SZa_editorSearchResult{width:100%;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-12);text-align:left;cursor:pointer;text-overflow:ellipsis;white-space:nowrap;background:0 0;border:none;border-radius:6px;padding:4px 8px;display:block;overflow:hidden}.AR6SZa_editorSearchResult:hover{background:var(--dsw-alias-interactive-bg-hover)}.AR6SZa_editorStatus{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary)}.AR6SZa_editorStatusError{color:var(--dsw-alias-state-error-primary)}.AR6SZa_dirtyDot{background:var(--dsw-alias-state-warn-primary);border-radius:50%;flex:none;width:7px;height:7px}.AR6SZa_editorPlaceholder{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);text-align:center;flex:1;justify-content:center;align-items:center;padding:16px;display:flex}.AR6SZa_orphanedType{opacity:.7;overflow-wrap:anywhere;margin-top:8px;font-size:12px;display:block}.AR6SZa_editorBinary{text-align:center;flex-direction:column;flex:1;justify-content:center;align-items:center;gap:12px;padding:24px 16px;display:flex}.AR6SZa_editorBinaryNotice{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary)}.AR6SZa_editorDownloadLink{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-strong-12);cursor:pointer;transition:background var(--ds-transition-duration-slow) var(--ds-ease-in-out), border-color var(--ds-transition-duration-slow) var(--ds-ease-in-out);border-radius:6px;align-items:center;gap:6px;padding:6px 14px;text-decoration:none;display:inline-flex}.AR6SZa_editorDownloadLink:hover{background:var(--dsw-alias-interactive-bg-hover);border-color:var(--dsw-alias-border-l2)}.AR6SZa_editorError{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-state-error-primary);padding:12px 16px}.AR6SZa_editorBanner{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-state-warn-label);background:var(--dsw-alias-state-warn-tertiary);flex:none;padding:4px 12px}.AR6SZa_sandboxStatus{font:var(--dsw-font-xxxs-11);flex:none;align-items:center;gap:8px;padding:4px 10px;display:flex}.AR6SZa_sandboxStatusOn{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);border-bottom:1px solid var(--dsw-alias-border-l1)}.AR6SZa_sandboxStatusOff{color:var(--dsw-alias-state-error-primary);background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 10%, transparent);border-bottom:1px solid color-mix(in srgb, var(--dsw-alias-state-error-primary) 45%, transparent)}.AR6SZa_sandboxDot{background:var(--dsw-alias-state-success-primary);border-radius:50%;flex:none;width:6px;height:6px}.AR6SZa_sandboxStatusOff .AR6SZa_sandboxDot{background:var(--dsw-alias-state-error-primary)}.AR6SZa_sandboxStatusText{text-overflow:ellipsis;white-space:nowrap;flex:1;min-width:0;overflow:hidden}.AR6SZa_sandboxAction{border:1px solid var(--dsw-alias-border-l2);font:inherit;color:inherit;cursor:pointer;background:0 0;border-radius:6px;flex:none;padding:2px 8px}.AR6SZa_sandboxAction:hover{background:var(--dsw-alias-interactive-bg-hover)}.AR6SZa_editorHtml{background:var(--dsw-alias-bg-base);border:none;flex:1;width:100%;min-height:0}.AR6SZa_browser{flex-direction:column;flex:1;min-height:0;display:flex}.AR6SZa_browserBar{border-bottom:1px solid var(--dsw-alias-border-l1);flex:none;align-items:center;gap:4px;padding:6px 8px;display:flex}.AR6SZa_browserInput{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);min-width:0;height:28px;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-12);border-radius:6px;flex:1;padding:0 10px}.AR6SZa_browserInput:focus{border-color:var(--dsw-alias-border-l2);outline:none}.AR6SZa_browserMessage{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-state-warn-label);background:var(--dsw-alias-state-warn-tertiary);flex:none;padding:4px 12px}.AR6SZa_browserFrame{background:var(--dsw-alias-bg-base);border:none;flex:1;width:100%;min-height:0}.AR6SZa_browserStart{text-align:center;min-height:0;font:var(--dsw-font-xs-13);color:var(--dsw-alias-label-tertiary);flex:1;justify-content:center;align-items:center;padding:20px;display:flex}.AR6SZa_browserBlocked{text-align:center;min-height:0;color:var(--dsw-alias-state-warn-primary);flex-direction:column;flex:1;justify-content:center;align-items:center;gap:6px;padding:24px;display:flex}.AR6SZa_browserBlockedTitle{font:var(--dsw-font-xxs-strong-12);color:var(--dsw-alias-label-primary)}.AR6SZa_browserBlockedDesc{max-width:280px;font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-secondary)}.AR6SZa_browserBlockedActions{gap:8px;margin-top:6px;display:flex}.AR6SZa_browserBlockedButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxxs-11);cursor:pointer;border-radius:6px;padding:4px 12px}.AR6SZa_browserBlockedButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.AR6SZa_editorCm{background:0 0;flex:1;min-height:0;overflow:hidden}.AR6SZa_editorCmHidden{display:none}.AR6SZa_editorCm .cm-editor{height:100%}.AR6SZa_editorCm .cm-editor.cm-focused{outline:none}.AR6SZa_editorModeToggle{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);border-radius:6px;flex:none;align-items:center;gap:2px;padding:2px;display:inline-flex}.AR6SZa_editorModeButton{color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xxxs-11);cursor:pointer;background:0 0;border:none;border-radius:4px;padding:2px 8px}.AR6SZa_editorModeButton:hover{color:var(--dsw-alias-label-primary)}.AR6SZa_editorModeActive{background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-primary)}.AR6SZa_editorImageWrap{flex:1;justify-content:center;align-items:center;min-height:0;padding:12px;display:flex;overflow:auto}.AR6SZa_editorImage{object-fit:contain;max-width:100%;max-height:100%}.AR6SZa_editorMd{min-height:0;font:var(--dsw-font-xs-13);flex:1;padding:10px 14px;overflow-y:auto}.AR6SZa_mermaidWrap{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);border-radius:6px;margin:6px 0;overflow:hidden}.AR6SZa_mermaidHeader{border-bottom:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-2);justify-content:space-between;align-items:center;gap:6px;padding:4px 8px;display:flex}.AR6SZa_mermaidInfo{font:var(--dsw-font-xxxs-strong-11);color:var(--dsw-alias-label-tertiary)}.AR6SZa_mermaidCopy{height:20px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxxs-11);cursor:pointer;background:0 0;border:none;border-radius:4px;align-items:center;gap:4px;padding:0 6px;display:inline-flex}.AR6SZa_mermaidCopy:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.AR6SZa_mermaidBody{cursor:zoom-in;justify-content:center;padding:10px;display:flex;overflow:auto}.AR6SZa_mermaidBody svg{max-width:100%;height:auto}.AR6SZa_mermaidError{border-bottom:1px solid var(--dsw-alias-border-l1);color:var(--dsw-alias-state-error-primary);font:var(--dsw-font-xxxs-11);padding:6px 10px}.AR6SZa_mermaidCode{font:var(--dsw-font-xxxs-11);margin:0;padding:8px 10px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;overflow:auto}.AR6SZa_mermaidMarkdown .md-code-block[data-mermaid-processed]{display:contents}.AR6SZa_mermaidModal{z-index:1000;background:var(--dsw-alias-bg-mask-1);backdrop-filter:blur(2px);flex-direction:column;justify-content:center;align-items:center;display:flex;position:fixed;inset:0}.AR6SZa_mermaidModalToolbar{z-index:10;gap:8px;display:flex;position:absolute;top:16px;right:16px}.AR6SZa_mermaidModalButton{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-2);width:36px;height:36px;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xs-strong-13);cursor:pointer;border-radius:8px;justify-content:center;align-items:center;display:inline-flex}.AR6SZa_mermaidModalButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.AR6SZa_mermaidModalStage{justify-content:center;align-items:center;width:90vw;height:80vh;display:flex;position:relative;overflow:hidden}.AR6SZa_mermaidModalStage svg{cursor:grab;transform-origin:50%;user-select:none;-webkit-user-drag:none;background:var(--dsw-alias-bg-layer-1);border-radius:12px;max-width:none;max-height:none;padding:16px}.AR6SZa_mermaidModalStage svg:active{cursor:grabbing}.AR6SZa_mermaidModalHint{color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xxxs-11);pointer-events:none;position:absolute;bottom:16px;left:50%;transform:translate(-50%)}.AR6SZa_selectionPopup{z-index:60;border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-2);height:28px;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxxs-strong-11);white-space:nowrap;cursor:pointer;border-radius:6px;align-items:center;padding:0 10px;display:inline-flex;position:fixed;transform:translate(-50%,calc(-100% - 8px))}.AR6SZa_selectionPopup:hover{background:var(--dsw-alias-interactive-bg-hover)}.AR6SZa_editorPdf{background:var(--dsw-alias-bg-base);flex-direction:column;flex:1;min-height:0;display:flex}.AR6SZa_editorPdfToolbar{border-bottom:1px solid var(--dsw-alias-border-l1);flex:none;justify-content:flex-end;padding:6px 8px;display:flex}.AR6SZa_editorPdfStage{flex:1;min-height:0;display:flex;position:relative}.AR6SZa_editorPdfFrame{background:var(--dsw-alias-bg-base);border:none;flex:1;width:100%;min-height:0}.AR6SZa_editorPdfFrameBlocked{pointer-events:none}.AR6SZa_editorPdfDragShield{z-index:4;pointer-events:none;background:0 0;position:absolute;inset:0}.AR6SZa_editorPdfDragShieldActive{pointer-events:auto}body[data-dsh-tab-dragging] .AR6SZa_editorPdfFrame{pointer-events:none!important}body[data-dsh-tab-dragging] .AR6SZa_editorPdfDragShield{pointer-events:auto!important}.AR6SZa_terminalWrap{background:var(--dsw-alias-bg-base);flex-direction:column;flex:1;min-height:0;display:flex;position:relative}.AR6SZa_terminal{flex:1;min-height:0;padding:6px 4px 6px 8px}.AR6SZa_terminal .xterm{height:100%}.AR6SZa_terminalBanner{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-state-warn-label);background:var(--dsw-alias-state-warn-tertiary);flex-wrap:wrap;flex:none;align-items:center;gap:8px;padding:3px 10px;display:flex}.AR6SZa_terminalBannerUrl{word-break:break-all;opacity:.85;flex-basis:100%;font-family:ui-monospace,SFMono-Regular,Menlo,monospace}.AR6SZa_boundaryError{z-index:50;background:var(--dsw-alias-bg-layer-1);border-left:1px solid var(--dsw-alias-border-l2);font:var(--dsw-font-xxs-12);color:var(--dsw-alias-state-error-primary);flex-direction:column;align-items:flex-start;gap:8px;padding:16px;display:flex;position:fixed;top:0;bottom:0;right:0;overflow:auto}.AR6SZa_terminalRetry{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxxs-strong-11);cursor:pointer;border-radius:999px;flex:none;padding:1px 8px}.AR6SZa_terminalRetry:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.AR6SZa_terminalDepsBanner{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-state-warn-label);background:var(--dsw-alias-state-warn-tertiary);flex-direction:column;flex:none;gap:6px;padding:10px;display:flex}.AR6SZa_terminalDepsTitle{font:var(--dsw-font-xxs-strong-12);color:var(--dsw-alias-state-warn-primary)}.AR6SZa_terminalDepsHint{opacity:.9}.AR6SZa_terminalDepsCommandRow{align-items:flex-start;gap:8px;display:flex}.AR6SZa_terminalRepairCommand{white-space:pre-wrap;word-break:break-all;user-select:text;min-width:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-2);border:1px solid var(--dsw-alias-border-l2);border-radius:4px;flex:1;max-height:160px;margin:0;padding:6px 8px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:11px;line-height:1.5;overflow:auto}.AR6SZa_terminalDepsNote{opacity:.85}.AR6SZa_terminalDepsActions{align-items:center;gap:8px;display:flex}.AR6SZa_tabBoundaryError{min-height:0;font:var(--dsw-font-xxs-12);color:var(--dsw-alias-state-error-primary);flex-direction:column;flex:1;align-items:flex-start;gap:8px;padding:12px 16px;display:flex;overflow:auto}.AR6SZa_git{flex-direction:column;flex:1;min-width:0;min-height:0;display:flex;overflow:hidden auto}.AR6SZa_gitHeader{flex:none;align-items:center;gap:8px;height:36px;padding:0 8px 0 12px;display:flex}.AR6SZa_gitBranchSelect{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);min-width:0;height:26px;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-12);border-radius:6px;flex:1;padding:0 6px}.AR6SZa_gitSection{border-top:1px solid var(--dsw-alias-border-l1)}.AR6SZa_gitSectionHeader{font:var(--dsw-font-xxxs-strong-11);color:var(--dsw-alias-label-tertiary);text-transform:uppercase;justify-content:space-between;align-items:center;padding:6px 12px 4px;display:flex}.AR6SZa_gitLink{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-brand-primary);cursor:pointer;background:0 0;border:none;padding:0}.AR6SZa_gitLink:hover:not(:disabled){text-decoration:underline}.AR6SZa_gitLink:disabled{opacity:.4;cursor:default}.AR6SZa_gitRow{min-height:34px;animation:AR6SZa_dsh-row-in .15s var(--ds-ease-in-out);border-radius:8px;align-items:center;gap:6px;margin:0 6px;padding:0 8px;display:flex}.AR6SZa_gitRow:hover{background:var(--dsw-alias-interactive-bg-hover)}.AR6SZa_gitRowSelected{background:var(--dsw-alias-interactive-bg-active)}.AR6SZa_gitRowMain{cursor:pointer;text-align:left;background:0 0;border:none;flex:1;align-items:center;gap:8px;min-width:0;padding:3px 0;display:flex}.AR6SZa_gitBadge{width:20px;height:16px;font:var(--dsw-font-xxxs-strong-11);background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary);border-radius:4px;flex:none;justify-content:center;align-items:center;display:inline-flex}.AR6SZa_gitName{text-overflow:ellipsis;white-space:nowrap;min-width:0;font:var(--dsw-font-s-14);color:var(--dsw-alias-label-primary);flex:1;overflow:hidden}.AR6SZa_gitEmpty{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);padding:4px 12px 8px}.AR6SZa_gitPlaceholder{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);text-align:center;padding:16px}.AR6SZa_gitError{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-state-error-primary);white-space:pre-wrap;padding:8px 12px}.AR6SZa_gitDiff{border-top:1px solid var(--dsw-alias-border-l1);padding:8px}.AR6SZa_gitDiffTab{flex-direction:column;flex:1;min-width:0;min-height:0;display:flex;overflow:hidden auto}.AR6SZa_gitDiffTabHeader{border-bottom:1px solid var(--dsw-alias-border-l1);flex:none;align-items:center;gap:8px;height:36px;padding:0 8px 0 12px;display:flex}.AR6SZa_gitDiffTabTitle{text-overflow:ellipsis;white-space:nowrap;min-width:0;font:var(--dsw-font-xxs-strong-12);color:var(--dsw-alias-label-primary);flex:1;overflow:hidden}.AR6SZa_gitDiffFile{align-items:baseline;gap:6px;padding:8px 2px 2px;display:flex}.AR6SZa_gitDiffFilePath{font:var(--dsw-font-xxs-strong-12);color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.AR6SZa_gitDiffFileOld{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:none;max-width:40%;overflow:hidden}.AR6SZa_gitDiffFileTag{border:1px solid var(--dsw-alias-border-l2);font:var(--dsw-font-xxxs-strong-11);color:var(--dsw-alias-label-secondary);border-radius:999px;flex:none;padding:0 6px}.AR6SZa_gitDiffHunk{font:var(--dsw-font-markdown-code-block-small);color:var(--dsw-alias-label-tertiary);gap:8px;padding:3px 2px;display:flex}.AR6SZa_gitDiffHunkHeader{color:var(--dsw-alias-label-secondary);flex:none}.AR6SZa_gitDiffHunkSection{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.AR6SZa_gitDiffLine{font:var(--dsw-font-markdown-code-block-small);white-space:pre-wrap;overflow-wrap:anywhere;align-items:stretch;min-width:0;line-height:20px;display:flex}.AR6SZa_gitDiffNum{text-align:right;width:36px;color:var(--dsw-alias-label-tertiary);user-select:none;flex:none;padding-right:8px}.AR6SZa_gitDiffCode{flex:1;min-width:0;overflow:visible}.AR6SZa_gitDiffCtx{color:var(--dsw-alias-label-primary)}.AR6SZa_gitDiffDel{color:var(--dsw-alias-state-error-primary);background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 12%, transparent)}.AR6SZa_gitDiffAdd{color:var(--dsw-alias-state-success-primary);background:color-mix(in srgb, var(--dsw-alias-state-success-primary) 12%, transparent)}.AR6SZa_gitDiffMeta{padding-left:2px}.AR6SZa_gitDiffMetaText{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary);font-style:italic}.AR6SZa_gitDiffExpand{width:100%;font:var(--dsw-font-xxs-12);color:var(--dsw-alias-brand-primary);cursor:pointer;text-align:center;background:0 0;border:none;margin:4px 0;display:block}.AR6SZa_gitDiffExpand:hover{background:var(--dsw-alias-interactive-bg-hover)}.AR6SZa_gitConfirmDesc{font:var(--dsw-font-s-14);color:var(--dsw-alias-label-primary);white-space:pre-wrap;margin:0}.AR6SZa_gitCommit{border-top:1px solid var(--dsw-alias-border-l1);align-items:center;gap:6px;padding:8px 12px;display:flex}.AR6SZa_gitCommitInput{flex:1;min-width:0}.AR6SZa_gitCommitButton{background:var(--dsw-alias-button-primary-fill);height:26px;color:var(--dsw-alias-label-primary-inverted);font:var(--dsw-font-xxs-strong-12);cursor:pointer;border:none;border-radius:6px;flex:none;padding:0 12px}.AR6SZa_gitCommitButton:hover:not(:disabled){background:var(--dsw-alias-button-primary-hover)}.AR6SZa_gitCommitButton:disabled{opacity:.45;cursor:default}.AR6SZa_gitLogRow{cursor:pointer;border-radius:8px;flex-direction:column;gap:2px;padding:5px 12px;display:flex}.AR6SZa_gitLogRow:hover{background:var(--dsw-alias-interactive-bg-hover)}.AR6SZa_gitLogLine1{align-items:baseline;gap:8px;min-width:0;display:flex}.AR6SZa_gitLogHash{font:var(--dsw-font-markdown-code-block-small);color:var(--dsw-alias-label-tertiary);flex:none}.AR6SZa_gitLogLine2{flex-wrap:wrap;align-items:center;gap:6px;min-width:0;display:flex}.AR6SZa_gitLogRef{border:1px solid var(--dsw-alias-border-l2);font:var(--dsw-font-xxxs-strong-11);color:var(--dsw-alias-brand-primary);white-space:nowrap;border-radius:999px;flex:none;padding:0 5px}.AR6SZa_gitLogSubject{text-overflow:ellipsis;white-space:nowrap;min-width:0;font:var(--dsw-font-s-14);color:var(--dsw-alias-label-primary);flex:1;overflow:hidden}.AR6SZa_gitLogMeta{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary)}.AR6SZa_gitLogMore{border:1px solid var(--dsw-alias-border-l2);width:calc(100% - 24px);font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border-radius:6px;margin:4px 12px 8px;padding:6px 0;display:block}.AR6SZa_gitLogMore:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.AR6SZa_gitLogMore:disabled{opacity:.5;cursor:default}.AR6SZa_producedRow{flex-wrap:wrap;align-items:center;gap:8px;padding:4px 0;display:flex}.AR6SZa_producedLabel{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary)}.AR6SZa_producedChip{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);max-width:200px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxs-12);cursor:pointer;border-radius:999px;align-items:center;gap:4px;padding:2px 8px;display:inline-flex;overflow:hidden}.AR6SZa_producedChip:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.AR6SZa_producedChip span{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.AR6SZa_producedMore{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary)}.AR6SZa_toggleButton:focus-visible,.AR6SZa_bottomClose:focus-visible,.AR6SZa_iconButton:focus-visible,.AR6SZa_tab:focus-visible,.AR6SZa_tabClose:focus-visible,.AR6SZa_tabBarPlus:focus-visible,.AR6SZa_paneCard:focus-visible,.AR6SZa_explorerRow:focus-visible,.AR6SZa_explorerRef:focus-visible,.AR6SZa_gitRowMain:focus-visible,.AR6SZa_gitLink:focus-visible,.AR6SZa_gitCommitButton:focus-visible,.AR6SZa_gitLogRow:focus-visible,.AR6SZa_gitLogMore:focus-visible,.AR6SZa_gitDiffExpand:focus-visible,.AR6SZa_terminalRetry:focus-visible,.AR6SZa_editorModeButton:focus-visible,.AR6SZa_editorDownloadLink:focus-visible,.AR6SZa_editorPptxButton:focus-visible,.AR6SZa_editorDocxZoomRange:focus-visible{outline:2px solid var(--dsw-alias-interactive-bg-hover-accent);outline-offset:-1px}@media (prefers-reduced-motion:reduce){.AR6SZa_panel,.AR6SZa_panelHidden,.AR6SZa_bottomPanel,.AR6SZa_bottomPanelHidden,.AR6SZa_toggleCluster,.AR6SZa_toggleButton,.AR6SZa_tab,.AR6SZa_tabBarPlus,.AR6SZa_paneCard,.AR6SZa_explorerRow,.AR6SZa_gitRow,.AR6SZa_divider,.AR6SZa_dividerRow:after,.AR6SZa_dividerCol:after{transition:none;animation:none}}@media (width<=767px){.AR6SZa_panel:not(.AR6SZa_panelHidden) .AR6SZa_tabBar{padding-right:40px}.AR6SZa_tab{min-width:48px;max-width:128px}}";
		const tagId$3 = "dsh-external/dsh-better-sidebar/sidebar.module.css";
		...
		var sidebar_module_css_default = {
			"selectionPopup": "AR6SZa_selectionPopup",
			"git": "AR6SZa_git",
			"gitHeader": "AR6SZa_gitHeader",
			"gitDiffMetaText": "AR6SZa_gitDiffMetaText",
			"explorerHeader": "AR6SZa_explorerHeader",
			"explorerHidden": "AR6SZa_explorerHidden",
			"editorMain": "AR6SZa_editorMain",
			"editorBinaryNotice": "AR6SZa_editorBinaryNotice",
			"panelResize": "AR6SZa_panelResize",
			"browserBar": "AR6SZa_browserBar",
			"editorPdfStage": "AR6SZa_editorPdfStage",
			"gitDiffCtx": "AR6SZa_gitDiffCtx",
			"gitDiffTabHeader": "AR6SZa_gitDiffTabHeader",
			"dropRight": "AR6SZa_dropRight",
			"editorSearchHint": "AR6SZa_editorSearchHint",
			"boundaryError": "AR6SZa_boundaryError",
			"sandboxStatusOn": "AR6SZa_sandboxStatusOn",
			"terminalRetry": "AR6SZa_terminalRetry",
			"toggleCluster": "AR6SZa_toggleCluster",
			"explorer": "AR6SZa_explorer",
			"dropLeft": "AR6SZa_dropLeft",
			"browserBlocked": "AR6SZa_browserBlocked",
			"terminalDepsBanner": "AR6SZa_terminalDepsBanner",
			"tabBoundaryError": "AR6SZa_tabBoundaryError",
			"gitLogSubject": "AR6SZa_gitLogSubject",
			"explorerSymlink": "AR6SZa_explorerSymlink",
			"editorImageWrap": "AR6SZa_editorImageWrap",
			"dividerRow": "AR6SZa_dividerRow",
			"tab": "AR6SZa_tab",
			"workbench": "AR6SZa_workbench",
			"splitCol": "AR6SZa_splitCol",
			"paneEmptyCards": "AR6SZa_paneEmptyCards",
			"gitEmpty": "AR6SZa_gitEmpty",
			"gitDiff": "AR6SZa_gitDiff",
			"gitDiffTabTitle": "AR6SZa_gitDiffTabTitle",
			"pane": "AR6SZa_pane",
			"bottomPanelHidden": "AR6SZa_bottomPanelHidden",
			"gitError": "AR6SZa_gitError",
			"editorPdfFrame": "AR6SZa_editorPdfFrame",
			"editorPdf": "AR6SZa_editorPdf",
			"dirtyDot": "AR6SZa_dirtyDot",
			"tabBarDrop": "AR6SZa_tabBarDrop",
			"editorHtml": "AR6SZa_editorHtml",
			"terminalDepsTitle": "AR6SZa_terminalDepsTitle",
			"gitDiffHunk": "AR6SZa_gitDiffHunk",
			"dropCenter": "AR6SZa_dropCenter",
			"tabBar": "AR6SZa_tabBar",
			"editorTreePanelFull": "AR6SZa_editorTreePanelFull",
			"editorBanner": "AR6SZa_editorBanner",
			"browserStart": "AR6SZa_browserStart",
			"mermaidWrap": "AR6SZa_mermaidWrap",
			"editor": "AR6SZa_editor",
			"editorPdfFrameBlocked": "AR6SZa_editorPdfFrameBlocked",
			"gitDiffDel": "AR6SZa_gitDiffDel",
			"gitLogMore": "AR6SZa_gitLogMore",
			"editorSearchInput": "AR6SZa_editorSearchInput",
			"mermaidModal": "AR6SZa_mermaidModal",
			"editorBody": "AR6SZa_editorBody",
			"producedRow": "AR6SZa_producedRow",
			"producedChip": "AR6SZa_producedChip",
			"editorBinary": "AR6SZa_editorBinary",
			"editorImage": "AR6SZa_editorImage",
			"splitChild": "AR6SZa_splitChild",
			"gitDiffHunkSection": "AR6SZa_gitDiffHunkSection",
			"bottomPanel": "AR6SZa_bottomPanel",
			"explorerError": "AR6SZa_explorerError",
			"sandboxAction": "AR6SZa_sandboxAction",
			"gitDiffAdd": "AR6SZa_gitDiffAdd",
			"gitConfirmDesc": "AR6SZa_gitConfirmDesc",
			"gitCommit": "AR6SZa_gitCommit",
			"mermaidModalHint": "AR6SZa_mermaidModalHint",
			"iconButton": "AR6SZa_iconButton",
			"gitLogMeta": "AR6SZa_gitLogMeta",
			"sandboxStatus": "AR6SZa_sandboxStatus",
			"editorPptxButton": "AR6SZa_editorPptxButton",
			"dropDown": "AR6SZa_dropDown",
			"browserInput": "AR6SZa_browserInput",
			"sandboxStatusOff": "AR6SZa_sandboxStatusOff",
			"browserBlockedActions": "AR6SZa_browserBlockedActions",
			"terminalWrap": "AR6SZa_terminalWrap",
			"gitLogRow": "AR6SZa_gitLogRow",
			"editorPlaceholder": "AR6SZa_editorPlaceholder",
			"mermaidInfo": "AR6SZa_mermaidInfo",
			"browser": "AR6SZa_browser",
			"explorerBroken": "AR6SZa_explorerBroken",
			"split": "AR6SZa_split",
			"mermaidBody": "AR6SZa_mermaidBody",
			"tabBadge": "AR6SZa_tabBadge",
			"editorDownloadLink": "AR6SZa_editorDownloadLink",
			"tabList": "AR6SZa_tabList",
			"mermaidError": "AR6SZa_mermaidError",
			"editorModeToggle": "AR6SZa_editorModeToggle",
			"explorerRow": "AR6SZa_explorerRow",
			"editorPdfDragShieldActive": "AR6SZa_editorPdfDragShieldActive",
			"terminalDepsHint": "AR6SZa_terminalDepsHint",
			"editorTreeToggleActive": "AR6SZa_editorTreeToggleActive",
			"editorStatus": "AR6SZa_editorStatus",
			"gitRowSelected": "AR6SZa_gitRowSelected",
			"gitName": "AR6SZa_gitName",
			"sandboxDot": "AR6SZa_sandboxDot",
			"gitDiffCode": "AR6SZa_gitDiffCode",
			"gitLogLine1": "AR6SZa_gitLogLine1",
			"editorHeader": "AR6SZa_editorHeader",
			"editorPathInput": "AR6SZa_editorPathInput",
			"bottomResize": "AR6SZa_bottomResize",
			"mermaidModalStage": "AR6SZa_mermaidModalStage",
			"panel": "AR6SZa_panel",
			"gitDiffFileOld": "AR6SZa_gitDiffFileOld",
			"gitCommitButton": "AR6SZa_gitCommitButton",
			"terminalDepsActions": "AR6SZa_terminalDepsActions",
			"editorMd": "AR6SZa_editorMd",
			"bottomResizeActive": "AR6SZa_bottomResizeActive",
			"terminalRepairCommand": "AR6SZa_terminalRepairCommand",
			"dropOverlay": "AR6SZa_dropOverlay",
			"tabTitle": "AR6SZa_tabTitle",
			"explorerDir": "AR6SZa_explorerDir",
			"editorStatusError": "AR6SZa_editorStatusError",
			"dividerActive": "AR6SZa_dividerActive",
			"dsh-row-in": "AR6SZa_dsh-row-in",
			"sandboxStatusText": "AR6SZa_sandboxStatusText",
			"divider": "AR6SZa_divider",
			"paneTabHidden": "AR6SZa_paneTabHidden",
			"editorPdfDragShield": "AR6SZa_editorPdfDragShield",
			"gitPlaceholder": "AR6SZa_gitPlaceholder",
			"gitCommitInput": "AR6SZa_gitCommitInput",
			"gitRow": "AR6SZa_gitRow",
			"editorTitle": "AR6SZa_editorTitle",
			"browserBlockedTitle": "AR6SZa_browserBlockedTitle",
			"explorerRoot": "AR6SZa_explorerRoot",
			"editorPdfToolbar": "AR6SZa_editorPdfToolbar",
			"mermaidModalButton": "AR6SZa_mermaidModalButton",
			"gitDiffMeta": "AR6SZa_gitDiffMeta",
			"editorTreeSearch": "AR6SZa_editorTreeSearch",
			"paneDrop": "AR6SZa_paneDrop",
			"editorModeActive": "AR6SZa_editorModeActive",
			"mermaidCode": "AR6SZa_mermaidCode",
			"gitBadge": "AR6SZa_gitBadge",
			"gitDiffFileTag": "AR6SZa_gitDiffFileTag",
			"gitLogHash": "AR6SZa_gitLogHash",
			"editorDocxZoomRange": "AR6SZa_editorDocxZoomRange",
			"panelBody": "AR6SZa_panelBody",
			"tabBarPlus": "AR6SZa_tabBarPlus",
			"explorerEmpty": "AR6SZa_explorerEmpty",
			"bottomClose": "AR6SZa_bottomClose",
			"mermaidMarkdown": "AR6SZa_mermaidMarkdown",
			"gitLink": "AR6SZa_gitLink",
			"panelHidden": "AR6SZa_panelHidden",
			"gitBranchSelect": "AR6SZa_gitBranchSelect",
			"toggleButton": "AR6SZa_toggleButton",
			"explorerName": "AR6SZa_explorerName",
			"tabClose": "AR6SZa_tabClose",
			"producedLabel": "AR6SZa_producedLabel",
			"explorerBody": "AR6SZa_explorerBody",
			"paneCard": "AR6SZa_paneCard",
			"browserFrame": "AR6SZa_browserFrame",
			"browserBlockedButton": "AR6SZa_browserBlockedButton",
			"gitDiffTab": "AR6SZa_gitDiffTab",
			"gitDiffLine": "AR6SZa_gitDiffLine",
			"terminalDepsNote": "AR6SZa_terminalDepsNote",
			"gitDiffFile": "AR6SZa_gitDiffFile",
			"terminalBanner": "AR6SZa_terminalBanner",
			"gitSectionHeader": "AR6SZa_gitSectionHeader",
			"editorCmHidden": "AR6SZa_editorCmHidden",
			"dividerCol": "AR6SZa_dividerCol",
			"terminalDepsCommandRow": "AR6SZa_terminalDepsCommandRow",
			"cornerHandle": "AR6SZa_cornerHandle",
			"explorerRef": "AR6SZa_explorerRef",
			"mermaidHeader": "AR6SZa_mermaidHeader",
			"terminalBannerUrl": "AR6SZa_terminalBannerUrl",
			"browserMessage": "AR6SZa_browserMessage",
			"editorSearchResult": "AR6SZa_editorSearchResult",
			"panelResizeActive": "AR6SZa_panelResizeActive",
			"splitRow": "AR6SZa_splitRow",
			"browserBlockedDesc": "AR6SZa_browserBlockedDesc",
			"editorModeButton": "AR6SZa_editorModeButton",
			"dropUp": "AR6SZa_dropUp",
			"editorTreeDock": "AR6SZa_editorTreeDock",
			"editorTreeResize": "AR6SZa_editorTreeResize",
			"gitDiffFilePath": "AR6SZa_gitDiffFilePath",
			"gitDiffNum": "AR6SZa_gitDiffNum",
			"gitDiffExpand": "AR6SZa_gitDiffExpand",
			"producedMore": "AR6SZa_producedMore",
			"gitSection": "AR6SZa_gitSection",
			"paneContent": "AR6SZa_paneContent",
			"terminal": "AR6SZa_terminal",
			"gitDiffHunkHeader": "AR6SZa_gitDiffHunkHeader",
			"mermaidModalToolbar": "AR6SZa_mermaidModalToolbar",
			"editorTreePanel": "AR6SZa_editorTreePanel",
			"gitRowMain": "AR6SZa_gitRowMain",
			"mermaidCopy": "AR6SZa_mermaidCopy",
			"orphanedType": "AR6SZa_orphanedType",
			"gitLogRef": "AR6SZa_gitLogRef",
			"gitLogLine2": "AR6SZa_gitLogLine2",
			"explorerCopied": "AR6SZa_explorerCopied",
			"tabActive": "AR6SZa_tabActive",
			"editorCm": "AR6SZa_editorCm",
			"paneTab": "AR6SZa_paneTab",
			"editorError": "AR6SZa_editorError"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/chunyu/.local/share/pnpm/store/v10/tmp/_tmp_579721_2c03618d695802c63117265cbda280a4/src/client/SubagentView.module.css.mjs
		const css$2 = ".CtMxnq_subagent{flex-direction:column;flex:1;min-height:0;display:flex}.CtMxnq_subagentHeader{flex:none;align-items:center;gap:8px;height:36px;padding:0 8px 0 12px;display:flex}.CtMxnq_subagentTitle{min-width:0;font:var(--dsw-font-s-14);color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:1;overflow:hidden}.CtMxnq_subagentCount{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary);flex:none}.CtMxnq_subagentRefresh{width:24px;height:24px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:6px;flex:none;justify-content:center;align-items:center;display:inline-flex}.CtMxnq_subagentRefresh:hover{background:var(--dsw-alias-interactive-bg-hover)}.CtMxnq_subagentBody{flex:1;min-height:0;padding:2px 6px 8px;overflow-y:auto}.CtMxnq_subagentRow{box-sizing:border-box;width:100%;min-height:50px;font:var(--dsw-font-s-14);color:var(--dsw-alias-label-primary);text-align:left;cursor:pointer;background:0 0;border:none;border-radius:8px;outline:none;align-items:flex-start;gap:8px;padding:7px 8px 7px 11px;display:flex;position:relative}.CtMxnq_subagentRow:hover,.CtMxnq_subagentRow:focus-visible{background:var(--dsw-alias-interactive-bg-hover)}.CtMxnq_subagentRowActive,.CtMxnq_subagentRowActive:hover,.CtMxnq_subagentRowActive:focus-visible{background:var(--dsw-alias-interactive-bg-active)}.CtMxnq_subagentRowDisabled{color:var(--dsw-alias-label-dimmed);cursor:not-allowed}.CtMxnq_subagentRowDisabled:hover{background:0 0}.CtMxnq_subagentRowLoading{cursor:default}.CtMxnq_subagentDot{margin-top:4px}.CtMxnq_subagentContent{flex-direction:column;flex:1;gap:2px;min-width:0;display:flex}.CtMxnq_subagentLabel,.CtMxnq_subagentSecondary{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.CtMxnq_subagentLabel{color:inherit;font-weight:400}.CtMxnq_subagentSecondary{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary)}.CtMxnq_subagentLive{min-width:0;font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary);align-items:baseline;gap:4px;display:flex;overflow:hidden}.CtMxnq_subagentLiveTool{font:var(--dsw-font-xxxs-strong-11);color:var(--dsw-alias-label-secondary);flex:none}.CtMxnq_subagentLiveArgs{min-width:0;font-family:var(--ds-font-family-code);font-size:var(--dsw-font-xxxs-11-font-size);line-height:var(--dsw-font-xxxs-11-line-height);color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.CtMxnq_subagentLiveText{-webkit-line-clamp:2;font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-secondary);-webkit-box-orient:vertical;display:-webkit-box;overflow:hidden}.CtMxnq_subagentNode{min-width:0;position:relative}.CtMxnq_subagentChildren{margin-left:18px;padding-left:4px;position:relative}.CtMxnq_subagentChildren:before{content:\"\";border-left:1px solid var(--dsw-alias-border-l2);height:26px;position:absolute;top:-26px;left:0}.CtMxnq_subagentChildren[aria-busy=true]:before{content:none}.CtMxnq_subagentChildren>.CtMxnq_subagentNode:before{content:\"\";border-left:1px solid var(--dsw-alias-border-l2);position:absolute;top:0;bottom:0;left:-4px}.CtMxnq_subagentChildren>.CtMxnq_subagentNode:last-child:before{height:17px;bottom:auto}.CtMxnq_subagentChildren>.CtMxnq_subagentNode>.CtMxnq_subagentRow:before{content:\"\";border-top:1px solid var(--dsw-alias-border-l2);width:14px;position:absolute;top:16px;left:-4px}.CtMxnq_subagentEmpty{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);text-align:center;flex-direction:column;gap:2px;padding:16px;display:flex}.CtMxnq_subagentEmptyHint{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-dimmed)}.CtMxnq_subagentError{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-state-error-primary);justify-content:space-between;align-items:center;gap:8px;padding:8px 10px;display:flex}.CtMxnq_subagentErrorRetry{height:24px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxxs-strong-11);cursor:pointer;background:0 0;border:none;border-radius:6px;flex:none;align-items:center;gap:4px;padding:0 8px;display:inline-flex}.CtMxnq_subagentErrorRetry:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.CtMxnq_jobs{border-top:1px solid var(--dsw-alias-border-l2);margin-top:10px;padding-top:8px}.CtMxnq_jobsHeader{align-items:center;gap:8px;height:26px;padding:0 2px;display:flex}.CtMxnq_jobsTitle{min-width:0;font:var(--dsw-font-xxxs-strong-11);color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:1;overflow:hidden}.CtMxnq_jobsCount{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary);flex:none}.CtMxnq_jobsList{flex-direction:column;gap:2px;margin:0;padding:0;list-style:none;display:flex}.CtMxnq_jobsRow{border-radius:8px;align-items:center;gap:4px;display:flex}.CtMxnq_jobsRow:hover{background:var(--dsw-alias-interactive-bg-hover)}.CtMxnq_jobsRowSettled{opacity:.8}.CtMxnq_jobsRowSelected,.CtMxnq_jobsRowSelected:hover{background:var(--dsw-alias-interactive-bg-active)}.CtMxnq_jobsRowMain{min-width:0;font:var(--dsw-font-s-14);color:var(--dsw-alias-label-primary);text-align:left;cursor:pointer;background:0 0;border:none;border-radius:8px;outline:none;flex:1;align-items:flex-start;gap:8px;padding:6px 8px 6px 11px;display:flex}.CtMxnq_jobsRowMain:focus-visible{background:var(--dsw-alias-interactive-bg-hover)}.CtMxnq_jobsDot{margin-top:5px}.CtMxnq_jobsContent{flex-direction:column;gap:1px;min-width:0;display:flex}.CtMxnq_jobsLabelLine{align-items:center;gap:6px;min-width:0;display:flex}.CtMxnq_jobsKind{text-overflow:ellipsis;white-space:nowrap;border:1px solid var(--dsw-alias-border-l2);max-width:90px;font:var(--dsw-font-xxxs-strong-11);color:var(--dsw-alias-label-tertiary);border-radius:4px;flex:none;padding:0 5px;line-height:14px;overflow:hidden}.CtMxnq_jobsLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-family:var(--ds-font-family-code);font-size:var(--dsw-font-xxxs-11-font-size);line-height:var(--dsw-font-xxxs-11-line-height);color:var(--dsw-alias-label-primary);flex:1;overflow:hidden}.CtMxnq_jobsSecondary{text-overflow:ellipsis;white-space:nowrap;font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary);overflow:hidden}.CtMxnq_jobsKill{width:22px;height:22px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:6px;flex:none;justify-content:center;align-items:center;margin-right:4px;display:inline-flex}.CtMxnq_jobsKill:hover{background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 12%, transparent);color:var(--dsw-alias-state-error-primary)}.CtMxnq_jobsKillArmed,.CtMxnq_jobsKillArmed:hover{background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 12%, transparent);width:auto;height:20px;color:var(--dsw-alias-state-error-primary);font:var(--dsw-font-xxxs-strong-11);white-space:nowrap;padding:0 8px}.CtMxnq_jobsKill:disabled{opacity:.5;cursor:default}.CtMxnq_jobsKillError{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-state-error-primary);flex:none;margin-right:4px}.CtMxnq_jobsPane{z-index:1;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);border-radius:8px;margin-top:4px;position:sticky;bottom:0;overflow:hidden;box-shadow:0 -6px 12px -8px #00000059}.CtMxnq_jobsPaneHeader{border-bottom:1px solid var(--dsw-alias-border-l1);align-items:center;gap:6px;height:28px;padding:0 4px 0 10px;display:flex}.CtMxnq_jobsPaneDot{flex:none}.CtMxnq_jobsPaneLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-family:var(--ds-font-family-code);font-size:var(--dsw-font-xxxs-11-font-size);line-height:var(--dsw-font-xxxs-11-line-height);color:var(--dsw-alias-label-primary);flex:1;overflow:hidden}.CtMxnq_jobsPaneStatus{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary);flex:none}.CtMxnq_jobsPaneClose{width:20px;height:20px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:5px;flex:none;justify-content:center;align-items:center;display:inline-flex}.CtMxnq_jobsPaneClose:hover{background:var(--dsw-alias-interactive-bg-hover)}.CtMxnq_jobsPanePre{max-height:200px;font-family:var(--ds-font-family-code);font-size:var(--dsw-font-xxxs-11-font-size);color:var(--dsw-alias-label-primary);white-space:pre-wrap;word-break:break-word;margin:0;padding:6px 10px;line-height:1.5;overflow:auto}.CtMxnq_jobsPaneHint{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary);padding:8px 10px}.CtMxnq_jobsPaneError{color:var(--dsw-alias-state-error-primary)}";
		...
		var SubagentView_module_css_default = {
			"jobsPaneHint": "CtMxnq_jobsPaneHint",
			"jobsRowSelected": "CtMxnq_jobsRowSelected",
			"jobsPaneLabel": "CtMxnq_jobsPaneLabel",
			"jobsTitle": "CtMxnq_jobsTitle",
			"jobsLabelLine": "CtMxnq_jobsLabelLine",
			"subagentError": "CtMxnq_subagentError",
			"jobsSecondary": "CtMxnq_jobsSecondary",
			"subagentEmpty": "CtMxnq_subagentEmpty",
			"subagentLiveText": "CtMxnq_subagentLiveText",
			"jobs": "CtMxnq_jobs",
			"subagentEmptyHint": "CtMxnq_subagentEmptyHint",
			"subagentErrorRetry": "CtMxnq_subagentErrorRetry",
			"subagentSecondary": "CtMxnq_subagentSecondary",
			"jobsHeader": "CtMxnq_jobsHeader",
			"jobsLabel": "CtMxnq_jobsLabel",
			"jobsKillArmed": "CtMxnq_jobsKillArmed",
			"jobsPaneClose": "CtMxnq_jobsPaneClose",
			"subagentLabel": "CtMxnq_subagentLabel",
			"jobsPanePre": "CtMxnq_jobsPanePre",
			"subagentRowLoading": "CtMxnq_subagentRowLoading",
			"jobsKill": "CtMxnq_jobsKill",
			"jobsDot": "CtMxnq_jobsDot",
			"subagentHeader": "CtMxnq_subagentHeader",
			"subagentLiveArgs": "CtMxnq_subagentLiveArgs",
			"subagentRefresh": "CtMxnq_subagentRefresh",
			"subagentRowDisabled": "CtMxnq_subagentRowDisabled",
			"subagentContent": "CtMxnq_subagentContent",
			"subagentRowActive": "CtMxnq_subagentRowActive",
			"subagentCount": "CtMxnq_subagentCount",
			"subagentBody": "CtMxnq_subagentBody",
			"subagentDot": "CtMxnq_subagentDot",
			"jobsList": "CtMxnq_jobsList",
			"jobsKind": "CtMxnq_jobsKind",
			"jobsKillError": "CtMxnq_jobsKillError",
			"jobsContent": "CtMxnq_jobsContent",
			"jobsPaneHeader": "CtMxnq_jobsPaneHeader",
			"subagentLive": "CtMxnq_subagentLive",
			"subagentChildren": "CtMxnq_subagentChildren",
			"jobsPaneDot": "CtMxnq_jobsPaneDot",
			"jobsPaneStatus": "CtMxnq_jobsPaneStatus",
			"jobsPaneError": "CtMxnq_jobsPaneError",
			"subagentLiveTool": "CtMxnq_subagentLiveTool",
			"subagentRow": "CtMxnq_subagentRow",
			"subagentTitle": "CtMxnq_subagentTitle",
			"jobsCount": "CtMxnq_jobsCount",
			"jobsRow": "CtMxnq_jobsRow",
			"jobsRowSettled": "CtMxnq_jobsRowSettled",
			"jobsPane": "CtMxnq_jobsPane",
			"subagentNode": "CtMxnq_subagentNode",
			"subagent": "CtMxnq_subagent",
			"jobsRowMain": "CtMxnq_jobsRowMain"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/chunyu/.local/share/pnpm/store/v10/tmp/_tmp_579721_2c03618d695802c63117265cbda280a4/src/client/SideCardSection.module.css.mjs
		const css$1 = "._4d-a1G_section{flex-direction:column;gap:14px;width:100%;max-width:760px;display:flex}._4d-a1G_intro{color:var(--dsw-alias-label-tertiary);margin:0;padding:0 2px;font-size:13px;line-height:20px}._4d-a1G_group{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:16px;flex-direction:column;flex:none;gap:8px;padding:18px 20px 20px;display:flex}._4d-a1G_groupHeading{color:var(--dsw-alias-label-primary);align-items:baseline;gap:7px;padding:0 2px 6px;font-size:13px;font-weight:600;line-height:20px;display:flex}._4d-a1G_count{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;font-size:12px;font-weight:400;line-height:18px}._4d-a1G_grid{grid-template-columns:repeat(auto-fill,minmax(168px,1fr));gap:10px;display:grid}._4d-a1G_card{border:1px solid var(--dsw-alias-border-l2);font:inherit;color:inherit;cursor:pointer;background:0 0;border-radius:12px;flex-direction:column;transition:background .12s,border-color .12s;display:flex;position:relative}._4d-a1G_card:not(._4d-a1G_cardOn):hover{background:var(--dsw-alias-interactive-bg-hover);border-color:var(--dsw-alias-label-dimmed)}._4d-a1G_cardOn{border-color:var(--dsw-alias-button-primary-fill);background:var(--dsw-alias-interactive-bg-active)}._4d-a1G_cardMain{border-radius:inherit;width:100%;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;flex-direction:column;gap:6px;padding:12px;display:flex}._4d-a1G_cardMain:focus-visible,._4d-a1G_cardGear:focus-visible,._4d-a1G_rowGear:focus-visible{outline:2px solid var(--dsw-alias-border-l4);outline-offset:2px}._4d-a1G_cardTop{align-items:center;gap:8px;min-width:0;display:flex}._4d-a1G_cardIconChip{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);width:28px;height:28px;color:var(--dsw-alias-label-tertiary);border-radius:8px;flex:none;justify-content:center;align-items:center;display:inline-flex}._4d-a1G_cardOn ._4d-a1G_cardIconChip{border-color:color-mix(in srgb, var(--dsw-alias-button-primary-fill) 35%, transparent);background:color-mix(in srgb, var(--dsw-alias-button-primary-fill) 12%, transparent);color:var(--dsw-alias-button-primary-fill)}._4d-a1G_cardTitle{min-width:0;color:var(--dsw-alias-label-secondary);white-space:nowrap;text-overflow:ellipsis;flex:1;font-size:13px;font-weight:600;line-height:20px;overflow:hidden}._4d-a1G_cardOn ._4d-a1G_cardTitle{color:var(--dsw-alias-label-primary)}._4d-a1G_cardCheck{background:var(--dsw-alias-button-primary-fill);width:16px;height:16px;color:var(--dsw-alias-bg-layer-3);border-radius:50%;flex:none;justify-content:center;align-items:center;display:inline-flex}._4d-a1G_cardDesc{color:var(--dsw-alias-label-tertiary);white-space:nowrap;text-overflow:ellipsis;font-size:11px;line-height:16px;overflow:hidden}._4d-a1G_addCard{border-style:dashed;border-color:var(--dsw-alias-border-l2);text-align:left;align-items:flex-start;padding:12px}._4d-a1G_addCard:hover{background:var(--dsw-alias-interactive-bg-hover);border-color:var(--dsw-alias-interactive-bg-hover-accent);color:var(--dsw-alias-label-primary)}._4d-a1G_addCard:hover ._4d-a1G_cardTitle{color:var(--dsw-alias-label-primary)}._4d-a1G_addCard:hover ._4d-a1G_cardIconChip{border-color:color-mix(in srgb, var(--dsw-alias-button-primary-fill) 35%, transparent);color:var(--dsw-alias-button-primary-fill)}._4d-a1G_addCard:focus-visible{outline:2px solid var(--dsw-alias-border-l4);outline-offset:2px}._4d-a1G_cardOn ._4d-a1G_cardDesc{color:var(--dsw-alias-label-secondary)}._4d-a1G_cardWithGear ._4d-a1G_cardDesc{padding-right:30px}._4d-a1G_cardGear{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:50%;justify-content:center;align-items:center;padding:0;display:inline-flex;position:absolute;top:46px;right:12px}._4d-a1G_cardGear:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}._4d-a1G_rowGear{width:22px;height:22px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}._4d-a1G_rowGear:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}._4d-a1G_row{border-bottom:1px solid var(--dsw-alias-border-l2);justify-content:space-between;align-items:center;gap:16px;padding:12px 2px;display:flex}._4d-a1G_row:last-child{border-bottom:none}._4d-a1G_rowText{flex-direction:column;gap:4px;min-width:0;display:flex}._4d-a1G_title{color:var(--dsw-alias-label-primary);font-size:14px;line-height:22px}._4d-a1G_desc{color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:18px}._4d-a1G_switch{cursor:pointer;flex:none;display:inline-flex;position:relative}._4d-a1G_switchInput{opacity:0;width:1px;height:1px;margin:0;position:absolute}._4d-a1G_switchTrack{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);border-radius:10px;align-items:center;width:36px;height:20px;padding:2px;transition:background .15s,border-color .15s;display:inline-flex}._4d-a1G_switchThumb{background:var(--dsw-alias-label-secondary);border-radius:50%;width:14px;height:14px;transition:transform .15s,background .15s;display:block}._4d-a1G_switch:hover ._4d-a1G_switchTrack{border-color:var(--dsw-alias-label-dimmed)}._4d-a1G_switchInput:checked+._4d-a1G_switchTrack{border-color:var(--dsw-alias-button-primary-fill);background:var(--dsw-alias-button-primary-fill)}._4d-a1G_switchInput:checked+._4d-a1G_switchTrack ._4d-a1G_switchThumb{background:var(--dsw-alias-bg-layer-3);transform:translate(16px)}._4d-a1G_switchInput:focus-visible+._4d-a1G_switchTrack{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px}._4d-a1G_control{flex:none;align-items:center;gap:6px;display:flex}._4d-a1G_percentInput{width:76px}._4d-a1G_typedInput{width:200px}._4d-a1G_typedInputNumber{width:76px}._4d-a1G_selectAnchor{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);max-width:220px;color:var(--dsw-alias-label-primary);cursor:pointer;border-radius:8px;align-items:center;gap:6px;padding:4px 8px;font-size:13px;line-height:20px;display:flex}._4d-a1G_selectAnchor:hover{border-color:var(--dsw-alias-label-dimmed)}._4d-a1G_selectAnchorIcon{flex:none;display:inline-flex}._4d-a1G_selectAnchorText{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}._4d-a1G_selectOption{align-items:center;gap:10px;min-width:200px;display:flex}._4d-a1G_selectOptionIcon{color:var(--dsw-alias-label-secondary);flex:none;display:inline-flex}._4d-a1G_selectOptionText{flex-direction:column;min-width:0;display:flex}._4d-a1G_suffix{color:var(--dsw-alias-label-secondary);font-size:14px;line-height:22px}._4d-a1G_popupDialog._4d-a1G_popupDialog{width:min(460px,100%)}._4d-a1G_popupRows{flex-direction:column;gap:10px;width:100%;display:flex}._4d-a1G_popupRow{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;justify-content:space-between;align-items:center;gap:16px;min-width:0;padding:14px 16px;transition:border-color .16s,background .16s;display:flex}._4d-a1G_popupRow:hover{border-color:var(--dsw-alias-label-dimmed)}._4d-a1G_done{appearance:none;font:inherit;cursor:pointer;background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3);border:1px solid #0000;border-radius:8px;padding:5px 14px;font-size:13px;line-height:1.5}._4d-a1G_done:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:1px}._4d-a1G_error{color:var(--dsw-alias-state-error-primary);padding:10px 0 2px;font-size:12px;line-height:17px}._4d-a1G_pluginModal._4d-a1G_pluginModal{width:min(560px,100%)}._4d-a1G_pluginList{flex-direction:column;gap:12px;width:100%;display:flex}._4d-a1G_pluginTopicBtn{appearance:none;border:1px solid var(--dsw-alias-border-l2);width:100%;font:inherit;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);cursor:pointer;border-radius:8px;padding:6px 12px;font-size:12px;line-height:18px}._4d-a1G_pluginTopicBtn:hover{background:var(--dsw-alias-interactive-bg-hover);border-color:var(--dsw-alias-interactive-bg-hover-accent);color:var(--dsw-alias-label-primary)}._4d-a1G_pluginTopicBtn:focus-visible{outline:2px solid var(--dsw-alias-border-l4);outline-offset:1px}._4d-a1G_pluginEmpty{color:var(--dsw-alias-label-tertiary);padding:20px 2px;font-size:12px;line-height:18px}._4d-a1G_pluginEntries{flex-direction:column;gap:10px;display:flex}._4d-a1G_pluginEntry{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);border-radius:12px;flex-direction:column;gap:4px;padding:12px;display:flex}._4d-a1G_pluginEntryHead{justify-content:space-between;align-items:center;gap:12px;display:flex}._4d-a1G_pluginEntryActions{flex:none;align-items:center;gap:6px;display:inline-flex}._4d-a1G_pluginJumpBtn{appearance:none;border:1px solid var(--dsw-alias-border-l2);font:inherit;cursor:pointer;color:var(--dsw-alias-label-secondary);background:0 0;border-radius:8px;flex:none;padding:3px 12px;font-size:12px;line-height:1.5}._4d-a1G_pluginJumpBtn:hover{background:var(--dsw-alias-interactive-bg-hover);border-color:var(--dsw-alias-interactive-bg-hover-accent);color:var(--dsw-alias-label-primary)}._4d-a1G_pluginJumpBtn:focus-visible{outline:2px solid var(--dsw-alias-border-l4);outline-offset:1px}._4d-a1G_pluginName{appearance:none;min-width:0;font:inherit;color:var(--dsw-alias-label-primary);text-align:left;text-overflow:ellipsis;white-space:nowrap;cursor:pointer;background:0 0;border:0;padding:0;font-size:13px;font-weight:600;line-height:20px;text-decoration:none;overflow:hidden}._4d-a1G_pluginName:hover{color:var(--dsw-alias-button-primary-fill);text-decoration:underline}._4d-a1G_pluginDesc{color:var(--dsw-alias-label-secondary);font-size:12px;line-height:18px}._4d-a1G_pluginInstall{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-2);border:1px solid var(--dsw-alias-border-l1);white-space:nowrap;border-radius:8px;padding:6px 10px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:11px;line-height:16px;display:block;overflow-x:auto}._4d-a1G_pluginCopyBtn{appearance:none;font:inherit;cursor:pointer;background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3);border:1px solid #0000;border-radius:8px;flex:none;padding:3px 12px;font-size:12px;line-height:1.5}._4d-a1G_pluginCopyBtn:hover{background:var(--dsw-alias-button-primary-hover)}._4d-a1G_pluginCopyBtn:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:1px}@media (prefers-reduced-motion:reduce){._4d-a1G_card,._4d-a1G_switchTrack,._4d-a1G_switchThumb{transition:none}}._4d-a1G_versionBadge{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);border-radius:999px;align-self:flex-start;align-items:center;gap:8px;padding:4px 12px 4px 14px;font-size:12px;line-height:18px;display:inline-flex}._4d-a1G_versionBadgeName{color:var(--dsw-alias-label-primary);font-weight:600}._4d-a1G_versionBadgeTag{background:var(--dsw-alias-accent-soft,var(--dsw-alias-border-l2));color:var(--dsw-alias-label-secondary);font-variant-numeric:tabular-nums;border-radius:999px;padding:1px 8px}._4d-a1G_pluginSearch{box-sizing:border-box;appearance:none;border:1px solid var(--dsw-alias-border-l2);width:100%;font:inherit;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);border-radius:8px;padding:6px 10px;font-size:12px;line-height:18px}._4d-a1G_pluginSearch::placeholder{color:var(--dsw-alias-label-tertiary)}._4d-a1G_pluginSearch:focus-visible{outline:2px solid var(--dsw-alias-border-l4);outline-offset:1px}._4d-a1G_pluginEntries{flex-direction:column;gap:10px;max-height:46vh;padding-right:2px;display:flex;overflow-y:auto}._4d-a1G_pluginGroup{flex-direction:column;gap:8px;display:flex}._4d-a1G_pluginGroupHeading{color:var(--dsw-alias-label-secondary);padding:2px 2px 0;font-size:12px;font-weight:600;line-height:18px}";
		...
		var SideCardSection_module_css_default = {
			"cardIconChip": "_4d-a1G_cardIconChip",
			"row": "_4d-a1G_row",
			"switchTrack": "_4d-a1G_switchTrack",
			"cardWithGear": "_4d-a1G_cardWithGear",
			"popupRows": "_4d-a1G_popupRows",
			"popupRow": "_4d-a1G_popupRow",
			"pluginTopicBtn": "_4d-a1G_pluginTopicBtn",
			"selectOption": "_4d-a1G_selectOption",
			"pluginName": "_4d-a1G_pluginName",
			"cardMain": "_4d-a1G_cardMain",
			"pluginJumpBtn": "_4d-a1G_pluginJumpBtn",
			"popupDialog": "_4d-a1G_popupDialog",
			"cardTitle": "_4d-a1G_cardTitle",
			"group": "_4d-a1G_group",
			"percentInput": "_4d-a1G_percentInput",
			"selectOptionText": "_4d-a1G_selectOptionText",
			"cardTop": "_4d-a1G_cardTop",
			"versionBadge": "_4d-a1G_versionBadge",
			"typedInput": "_4d-a1G_typedInput",
			"pluginList": "_4d-a1G_pluginList",
			"cardOn": "_4d-a1G_cardOn",
			"versionBadgeName": "_4d-a1G_versionBadgeName",
			"control": "_4d-a1G_control",
			"selectAnchorIcon": "_4d-a1G_selectAnchorIcon",
			"rowGear": "_4d-a1G_rowGear",
			"suffix": "_4d-a1G_suffix",
			"error": "_4d-a1G_error",
			"pluginEntryActions": "_4d-a1G_pluginEntryActions",
			"pluginInstall": "_4d-a1G_pluginInstall",
			"pluginSearch": "_4d-a1G_pluginSearch",
			"intro": "_4d-a1G_intro",
			"switch": "_4d-a1G_switch",
			"selectAnchorText": "_4d-a1G_selectAnchorText",
			"cardDesc": "_4d-a1G_cardDesc",
			"pluginGroup": "_4d-a1G_pluginGroup",
			"switchThumb": "_4d-a1G_switchThumb",
			"desc": "_4d-a1G_desc",
			"typedInputNumber": "_4d-a1G_typedInputNumber",
			"pluginEmpty": "_4d-a1G_pluginEmpty",
			"grid": "_4d-a1G_grid",
			"card": "_4d-a1G_card",
			"addCard": "_4d-a1G_addCard",
			"groupHeading": "_4d-a1G_groupHeading",
			"pluginEntryHead": "_4d-a1G_pluginEntryHead",
			"pluginCopyBtn": "_4d-a1G_pluginCopyBtn",
			"done": "_4d-a1G_done",
			"rowText": "_4d-a1G_rowText",
			"versionBadgeTag": "_4d-a1G_versionBadgeTag",
			"pluginEntries": "_4d-a1G_pluginEntries",
			"pluginModal": "_4d-a1G_pluginModal",
			"cardGear": "_4d-a1G_cardGear",
			"section": "_4d-a1G_section",
			"switchInput": "_4d-a1G_switchInput",
			"selectAnchor": "_4d-a1G_selectAnchor",
			"pluginDesc": "_4d-a1G_pluginDesc",
			"pluginGroupHeading": "_4d-a1G_pluginGroupHeading",
			"count": "_4d-a1G_count",
			"cardCheck": "_4d-a1G_cardCheck",
			"title": "_4d-a1G_title",
			"selectOptionIcon": "_4d-a1G_selectOptionIcon",
			"pluginEntry": "_4d-a1G_pluginEntry"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/chunyu/.local/share/pnpm/store/v10/tmp/_tmp_579721_2c03618d695802c63117265cbda280a4/src/client/layout.css.mjs
